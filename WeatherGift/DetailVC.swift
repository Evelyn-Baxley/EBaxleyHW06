    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            if currentPage == 0 && self.view.window != nil {
                showAlert(title: "User has no authorized location services", message: "Open the Settings app > Pricacy > Location Services > WeatherGift to enable location services in this app.")
            }
        case .restricted:
